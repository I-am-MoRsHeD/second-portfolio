...
const Projects = () => {
    return (
        <div id="projects" className="mx-3 lg:mx-0 my-20 style">
             ...
             <div className="my-10">
                ...
                <div data-aos="fade-up"
                    ...
                    <div className=" lg:w-96 w-full ml-0 py-5 px-5">
                        ...
                        <div className="card-actions items-center justify-start mt-3">
                            <Link to='https://vip-tailor.vercel.app' target="blank" className='btn btn-outline'>Live Link</Link>
                        </div>
                    </div>
                </div>
                {/* Alamgir super shob */}
                <div data-aos="fade-up"
                    ...
                    <div className=" lg:w-96 w-full ml-0 py-5 px-5">
                        ...
                        <p className='text-justify'>This is basically a Inventory system website.But this is kind of different.There have many branch and every branch have different statement.There are two types of users such as Employee and Admin.Admin will handle all the system and make one user/employee admin or delete and everything.</p>
                        <div className="my-1">
                            <p className="font-semibold underline">Demo(Admin):</p>
                            <p>email: morshed@gmail.com</p>
                            <p>pass: 123456</p>
                        </div>
                        <div className="card-actions items-center justify-start mt-3">
                            <Link to='https://super-shop-project-2.vercel.app' target="blank" className='btn btn-outline'>Live Link</Link>
                        </div>
                    </div>
                </div>
                {/* ChikitshaHub */}
