...
const Projects = () => {
    return (
        <div id="projects" className="mx-12 my-20 style">
            ...
            <div className="my-10">
                ...
                <div data-aos="fade-up"
                    data-aos-duration="1000" className="flex flex-col lg:flex-row bg-base-200 mb-5 h-[370px]">
                    <div className='lg:w-9/12 w-full'>
                        <img className='w-8/12 image shadow-xl shadow-black' src="https://i.ibb.co/2k71jQv/am12-ss.png" alt="Movie" />
                    </div>
                    <div className=" lg:w-96 w-full ml-0 py-5 pr-5">
                ...
                {/* Jobs World */}
                <div data-aos="fade-up"
                    data-aos-duration="1000" className="flex flex-col lg:flex-row bg-base-200 mb-5 h-[400px]">
                    <div className='lg:w-9/12 w-full'>
                        <img className='w-8/12 image shadow-xl shadow-black' src="https://i.ibb.co/nBCSGmW/Screenshot-67.png" alt="Movie" />
                    </div>
                    <div className=" lg:w-96 w-full ml-0 py-5 pr-5">
                ...
                {/* Tech Brand */}
                <div data-aos="fade-up"
                    data-aos-duration="1000" className="flex flex-col lg:flex-row bg-base-200 h-[370px]">
                    <div className='lg:w-9/12 w-full'>
                        <img className='w-8/12 image shadow-xl shadow-black' src="https://i.ibb.co/47sh7yz/Screenshot-68.png" alt="Movie" />
                    </div>
                    <div className=" lg:w-96 w-full ml-0 py-5 pr-5">
            ...
            <div className="my-20">
                ...
                <div data-aos="fade-up"
                    data-aos-duration="1000" className="flex flex-col lg:flex-row bg-base-200 mb-5 h-[370px]">
                    <div className='lg:w-9/12 w-full'>
                        <img className='w-8/12 image shadow-xl shadow-black' src="https://i.ibb.co/1qwGq4F/vip-Tailor.jpg" alt="Movie" />
                    </div>
                    <div className=" lg:w-96 w-full ml-0 py-5 pr-5">
                ...
                <div data-aos="fade-up"
                    data-aos-duration="1000" className="flex flex-col lg:flex-row bg-base-200 mb-5 h-[370px]">
                    <div className='lg:w-9/12 w-full'>
                        <img className='w-8/12 image shadow-xl shadow-black' src="https://i.ibb.co/vh1jbby/alamgir-Super.jpg" alt="Movie" />
                    </div>
                    <div className=" lg:w-96 w-full ml-0 py-5 pr-5">
                ...
                <div data-aos="fade-up"
                    data-aos-duration="1000" className="flex flex-col lg:flex-row bg-base-200 mb-5 h-[370px]">
                    <div className='lg:w-9/12 w-full'>
                        <img className='w-8/12 image shadow-xl shadow-black' src="https://i.ibb.co/BKzxRg3/Screenshot-128.png" alt="Movie" />
                    </div>
                    <div className=" lg:w-96 w-full ml-0 py-5 pr-5">
